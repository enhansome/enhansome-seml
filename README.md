...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,528 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,081 | 🐛 925 | 🌐 TypeScript | 📅 2026-08-18 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,717 | 🐛 34 | 🌐 Python | 📅 2026-08-18 - Data validation and testing with integration in pipelines.
