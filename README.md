...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,551 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,305 | 🐛 1,083 | 🌐 Python | 📅 2026-08-25 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,135 | 🐛 925 | 🌐 TypeScript | 📅 2026-08-25 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,734 | 🐛 39 | 🌐 Python | 📅 2026-08-25 - Data validation and testing with integration in pipelines.
...
* [Archai](https://github.com/microsoft/archai) ⭐ 485 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Neural architecture search.
