...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,541 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,300 | 🐛 1,084 | 🌐 Python | 📅 2026-08-09 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,113 | 🐛 925 | 🌐 TypeScript | 📅 2026-08-21 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,730 | 🐛 39 | 🌐 Python | 📅 2026-08-21 - Data validation and testing with integration in pipelines.
...
* [Archai](https://github.com/microsoft/archai) ⭐ 485 | 🐛 5 | 🌐 Python | 📅 2025-11-24 - Neural architecture search.
