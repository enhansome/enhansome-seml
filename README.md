...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,350 | 🐛 1,086 | 🌐 Python | 📅 2026-09-17 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,296 | 🐛 950 | 🌐 TypeScript | 📅 2026-09-19 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,801 | 🐛 65 | 🌐 Python | 📅 2026-09-18 - Data validation and testing with integration in pipelines.
