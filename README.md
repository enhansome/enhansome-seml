# Awesome Software Engineering for Machine Learning with stars
...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,498 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,288 | 🐛 1,064 | 🌐 Python | 📅 2026-08-09 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,038 | 🐛 923 | 🌐 TypeScript | 📅 2026-08-13 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,708 | 🐛 38 | 🌐 Python | 📅 2026-08-13 - Data validation and testing with integration in pipelines.
* [Seldon Core](https://github.com/SeldonIO/seldon-core) ⭐ 4,770 | 🐛 396 | 🌐 Go | 📅 2026-03-23 - An MLOps framework to package, deploy, monitor and manage thousands of production machine learning models on Kubernetes.
* [Alibi Detect](https://github.com/SeldonIO/alibi-detect) ⭐ 2,546 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2025-12-11 - Python library focused on outlier, adversarial and drift detection.
* [Tensorflow Data Validation (TFDV)](https://github.com/tensorflow/data-validation) ⭐ 783 | 🐛 16 | 🌐 Python | 📅 2026-06-11 - Library for exploring and validating machine learning data. Similar to Great Expectations, but for Tensorflow data.
* [Neuraxle](https://github.com/Neuraxio/Neuraxle) ⭐ 614 | 🐛 2 | 🌐 Python | 📅 2026-02-20 -  Sklearn-like framework for hyperparameter tuning and AutoML in deep learning projects.
* [Archai](https://github.com/microsoft/archai) ⭐ 485 | 🐛 4 | 🌐 Python | 📅 2025-11-24 - Neural architecture search.
* [Robustness Metrics](https://github.com/google-research/robustness_metrics) ⭐ 474 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-07-07 - Lightweight modules to evaluate the robustness of classification models.
...
* [HParams](https://github.com/PetrochukM/HParams) ⭐ 131 | 🐛 5 | 🌐 Python | 📅 2024-11-18 - A thoughtful approach to configuration management for machine learning projects.
* [REVISE: REvealing VIsual biaSEs](https://github.com/princetonvisualai/revise-tool) ⭐ 110 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-08-19 - Automatically detect bias in visual data sets.
