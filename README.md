...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,509 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,287 | 🐛 1,071 | 🌐 Python | 📅 2026-08-09 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,058 | 🐛 923 | 🌐 TypeScript | 📅 2026-08-14 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,709 | 🐛 34 | 🌐 Python | 📅 2026-08-14 - Data validation and testing with integration in pipelines.
...
* [Tensorflow Data Validation (TFDV)](https://github.com/tensorflow/data-validation) ⭐ 783 | 🐛 17 | 🌐 Python | 📅 2026-06-11 - Library for exploring and validating machine learning data. Similar to Great Expectations, but for Tensorflow data.
