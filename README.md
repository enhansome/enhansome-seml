...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,543 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,122 | 🐛 926 | 🌐 TypeScript | 📅 2026-08-24 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,732 | 🐛 39 | 🌐 Python | 📅 2026-08-21 - Data validation and testing with integration in pipelines.
