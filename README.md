...
* [Machine Learning Interviews](https://github.com/chiphuyen/machine-learning-systems-design/blob/master/build/build1/consolidated.pdf) ⭐ 10,562 | 🐛 11 | 🌐 HTML | 📅 2023-04-15
...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,315 | 🐛 1,079 | 🌐 Python | 📅 2026-08-25 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,165 | 🐛 927 | 🌐 TypeScript | 📅 2026-08-28 - A multi-type data labeling and annotation tool with standardized output format.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,745 | 🐛 31 | 🌐 Python | 📅 2026-08-28 - Data validation and testing with integration in pipelines.
...
* [Neuraxle](https://github.com/Neuraxio/Neuraxle) ⭐ 613 | 🐛 2 | 🌐 Python | 📅 2026-02-20 -  Sklearn-like framework for hyperparameter tuning and AutoML in deep learning projects.
* [Archai](https://github.com/microsoft/archai) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Neural architecture search.
...
* [REVISE: REvealing VIsual biaSEs](https://github.com/princetonvisualai/revise-tool) ⭐ 109 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-08-19 - Automatically detect bias in visual data sets.
