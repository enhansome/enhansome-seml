...
* [PyTorch Lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,340 | 🐛 1,087 | 🌐 Python | 📅 2026-09-12 - The lightweight PyTorch wrapper for high-performance AI research. Scale your models, not the boilerplate.
* [Label Studio](https://github.com/heartexlabs/label-studio) ⭐ 28,254 | 🐛 944 | 🌐 TypeScript | 📅 2026-09-11 - A multi-type data labeling and annotation tool with standardized output format.
